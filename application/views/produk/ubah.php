									...
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<select class="custom-select" name="id_kategori">
												<option selected value="<?= $produk->id_kategori ?>"> Ganti Kategori </option>
										...
										<div class="form-group col-md-6">
											...
											<input type="text" name="harga" placeholder="Masukkan Nama Produk" autocomplete="off"  class="form-control" required value="<?= $produk->harga ?>">
										</div>
									</div>
									<hr>
