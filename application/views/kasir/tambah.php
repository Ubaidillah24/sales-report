...
<body id="page-top">
								...
								<form action="<?= base_url('kasir/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="nik"><strong>MIK Kasir</strong></label>
											<input type="text" name="nik" placeholder="Masukkan NIK kasir" autocomplete="off"  class="form-control">
										</div>
										<div class="form-group col-md-6">
	...
	<!-- <script>
		$(document).ready(function(){
			let username = $('input[name="nik"]').val().split(' - ');
