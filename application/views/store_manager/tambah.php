				...
				<div class="row">
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('store_manager/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="kode"><strong>Kode</strong></label>
											<input type="text" name="kode" placeholder="Masukkan Kode store_manager" autocomplete="off"  class="form-control" required value="SM - <?= mt_rand(10, 99) ?>" maxlength="8" readonly>
										</div>
										<div class="form-group col-md-6">
									...
									<div class="form-group">
											...
											<input type="text" name="nama" placeholder="Masukkan Nama store_manager" autocomplete="off"  class="form-control" required>
										</div>
									<div class="form-row">
										<div class="form-group col-md-6">
