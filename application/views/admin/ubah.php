				...
				<div class="row">
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('admin/proses_ubah/' . $admin->id) ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="kode"><strong>Kode admin</strong></label>
											<input type="text" name="kode" placeholder="Masukkan Kode admin" autocomplete="off"  class="form-control" required value="<?= $admin->kode ?>" maxlength="8" readonly>
										</div>
										<div class="form-group col-md-6">
